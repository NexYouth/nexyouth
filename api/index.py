        ...
        <div class="container">
            ...
            <div class="who-we-are-content">
                <div class="who-we-are-text">
                    <p>We began as a small group of passionate high school students with a vision to empower youth worldwide. Since our founding, we've grown into a vibrant global community mobilizing thousands of young leaders for positive change.</p>
                    <p>Our organization is built on the belief that young people have the power to shape the future. We've established partnerships across multiple continents, creating opportunities for youth to develop skills, gain mentorship, and take meaningful action in their communities.</p>
                    <p>With a diverse team of youth leaders from around the world, we're committed to breaking barriers and providing equitable access to education, professional development, and leadership experiences.</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="our-story-content">
                <div class="our-story-text">
                    <p>NexYouth was born from the frustration we felt seeing talented youth without access to meaningful learning opportunities and mentorship. We recognized that the barriers to entry in professional development were too high for many young people.</p>
                    <p>In 2023, our co-founders came together with a simple mission: create a platform where youth can develop skills, connect with mentors, and take action on issues they care about. Starting with a small group of volunteers, we've now grown to serve thousands of young people across multiple countries.</p>
                    <p>Our journey has taught us that when you empower young people with the right tools, mentorship, and community, they can achieve extraordinary things. Every day, our team works to expand access and make a tangible difference in the lives of aspiring young leaders.</p>
                </div>
...
<body>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSeZJXno8J8DlmbDI-zlGVHr6YX8n4iH-90N1Dp6jw21V99JKw/viewform" target="_blank" class="cta-btn">Sign Up</a>
        </div>
    </section>
